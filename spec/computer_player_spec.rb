...
RSpec.describe ComputerPlayer do
  ...
  context "Gets a valid move" do
    ...
    it "stops computer player repeating the same move after it has blocked a fork" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(9)
    end
  end
  ...
  context "Plays a strategic move" do
    it "plays 5 as first move" do
      opponent_mark = "O"
      expect(computer_player.get_valid_move(unmarked_grid, unmarked_move_sequences, player_mark, opponent_mark, converter_instance)).to eq(5)
    end
    ...
    it "plays a corner move as the first move if 5 is taken" do
      ...
      expect(corner_moves.include?(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance))).to eq(true)
    end
    ...
    it "plays a move choosing from the only available moves left" do
      ...
      available_moves = [2, 8]
      expect(available_moves.include?(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance))).to eq(true)
    end
    ...
    it "plays 1 if opponent has played 4, 2" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(1)
    end
    ...
    it "plays 3 if opponent has played 2, 6" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(3)
    end
    ...
    it "plays 7 if opponent plays 8, 4" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(7)
    end
    ...
    it "plays 6 if opponent plays 1, 9" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(6)
    end
    ...
    it "plays 4 if opponent plays 3,7" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(4)
    end
  ...
  context "Plays a winning move" do
    ...
    it "plays 6 as the winning move" do
      ...
      opponent_mark = "O"
      expect(computer_player.get_valid_move(current_grid, move_sequences, "X", opponent_mark, converter_instance)).to eq(6)
    end
    ...
    it "plays 5 as the winning move" do
      ...
      opponent_mark = "O"
      expect(computer_player.get_valid_move(current_grid, move_sequences, "X", opponent_mark, converter_instance)).to eq(5)
    end
    ...
    it "plays 9 as the winning move" do
      ...
      opponent_mark = "O"
      expect(computer_player.get_valid_move(current_grid, move_sequences, "X", opponent_mark, converter_instance)).to eq(9)
    end
    ...
    it "returns 3 if sequence has 2 player marks and one available move" do
      ...
      opponent_mark = "O"
      expect(computer_player.get_valid_move(current_grid, move_sequences, "X", opponent_mark, converter_instance)).to eq(3)
    end
  end
  ...
  context "Defends against opponent" do
    ...
    it "plays 8 to block the opponent's winning move" do
      ...
      opponent_mark = "O"
      expect(computer_player.get_valid_move(current_grid, move_sequences, "X", opponent_mark, converter_instance)).to eq(8)
    end
    ...
    it "blocks a winning move before it blocks a fork" do
      ...
      expect(computer_player.get_valid_move(current_grid, move_sequences, player_mark, opponent_mark, converter_instance)).to eq(2)
    end
  end
end
